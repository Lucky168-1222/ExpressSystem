                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr>
                                ...
                                <td style="background: #fff">
                                    <input style="border:0;" class="comname" name="comname" disabled type="text"  value="<?php echo $mess['name']; ?>"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">公司所在地</td>
                                <td style="background: #fff">
                                    <input style="border:0;" class="comadress" name="comadress" disabled type="text"  value="<?php echo $mess['inaddress']; ?>"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">公司注册地</td>
                                <td style="background: #fff"><input style="border:0;" disabled type="text"  value="<?php echo $mess['regaddress']; ?>"/></td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">公司负责人</td>
                                <td style="background: #fff">
                                    <input style="border:0;" class="comperson" name="comperson" disabled type="text"  value="<?php echo $mess['principal']; ?>"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">公司联系电话</td>
                                <td style="background: #fff">
                                    <input style="border:0;" class="comtel" name="comtel" disabled type="text"  value="<?php echo $mess['phone']; ?>"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">公司邮箱</td>
                                <td style="background: #fff">
                                    <input style="border:0;" class="comemail" name="comemail" disabled type="text"  value="<?php echo $mess['email']; ?>"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">注册资本</td>
                                <td style="background: #fff"><input style="border:0;" disabled type="text"  placeholder="<?php echo $mess['regmoney']; ?>"/></td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">公司信息变更时间</td>
                                <td style="background: #fff"><input style="border:0;" disabled type="text"  placeholder="<?php echo $mess['updatetime']; ?>"/></td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">公司简介</td>
                                <td style="background: #fff">
                                    <input style="border:0;" class="comdesc" name="comdesc" disabled type="text"  value="<?php echo $mess['description']; ?>"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
