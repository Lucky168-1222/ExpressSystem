<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"/opt/lampp/htdocs/tp5/public/../application/admin/view/express/index.html";i:1529051547;s:63:"/opt/lampp/htdocs/tp5/application/admin/view/public/header.html";i:1529123472;s:63:"/opt/lampp/htdocs/tp5/application/admin/view/public/bottom.html";i:1529051547;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">快件管理->现存快件</h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <form style="float: right" role="form" method="post" action="<?php echo url('express/index'); ?>" name="indexexpress">
                        ...
                        <?php else: ?>
                        <input type="text" style="height: 30px;border-radius: 4px;margin-left: 20px;" name="mess" placeholder="编号/人/网点"/>
                        <?php endif; ?>
                ...
                <div class="panel-body">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tr class="odd gradeX">
                            ...
                            <?php if($one['status'] == 1): ?>
                            <td class="center">已入仓</td>
                            <?php elseif($one['status'] == 2): ?>
                            <td class="center">已出仓</td>
                            <?php elseif($one['status'] == 3): ?>
                            <td class="center">派件中</td>
                            <?php elseif($one['status'] == 4): ?>
                            ...
                            <td class="center">
                                ...
                                <button class="btn btn-success" onclick="javascript:showupdate('<?php echo $points; ?>','<?php echo $one['nextpoint']; ?>','<?php echo $one['number']; ?>','<?php echo $one['expressnumber']; ?>')">更新</button>
                                <a href="/tp5/public/admin/express/changeexpress?id=<?php echo $one['number']; ?>" style="color: #fff;"><button class="btn btn-warning">修改</button></a>
                                <a href="/tp5/public/admin/express/deleteexpress?id=<?php echo $one['number']; ?>" style="color: #fff;"><button class="btn btn-danger">删除</button></a>
                            </td>
                        </tr>
