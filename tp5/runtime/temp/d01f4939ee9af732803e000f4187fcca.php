<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/opt/lampp/htdocs/tp5/public/../application/admin/view/express/changeexpress.html";i:1527862077;s:63:"/opt/lampp/htdocs/tp5/application/admin/view/public/header.html";i:1527862077;s:63:"/opt/lampp/htdocs/tp5/application/admin/view/public/bottom.html";i:1527862077;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">快件管理->修改快件</h2>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="index.html">快件列表</a> >> <a href="#">快件基本信息修改</a>
                </div>
                <form role="form" method="post" action="<?php echo url('express/changeexpress'); ?>" name="changepress">
                    <!-- /.panel-heading -->
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td style="background: #fff">
                                    <input name="expressnumber" value="<?php echo $mess['number']; ?>" style="width: 200px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">寄件人姓名</td>
                                <td style="background: #fff">
                                    <input name="postname" value="<?php echo $mess['postname']; ?>" style="width: 200px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">寄件人电话</td>
                                <td style="background: #fff">
                                    <input name="postphone" value="<?php echo $mess['postphone']; ?>"  style="width: 200px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">寄件人地址</td>
                                <td style="background: #fff">
                                    <input name="postaddress" value="<?php echo $mess['postaddress']; ?>" style="width: 200px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">收件人姓名</td>
                                <td style="background: #fff">
                                    <input name="receivename" value="<?php echo $mess['receivename']; ?>"  style="width: 200px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">收件人电话</td>
                                <td style="background: #fff">
                                    <input name="receivephone" value="<?php echo $mess['receivephone']; ?>"  style="width: 200px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">收件人地址</td>
                                <td style="background: #fff">
                                    <input name="receiveaddress" value="<?php echo $mess['receiveaddress']; ?>"  style="width: 200px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">收件价格</td>
                                <td style="background: #fff">
                                    <input name="price" value="<?php echo $mess['price']; ?>"  style="width: 200px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">快件负责人</td>
                                <td style="background: #fff">
                                    <input name="principalname" value="<?php echo $mess['principalname']; ?>"  style="width: 200px;"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">寄件网点</td>
                                <td style="background: #fff">
                                    <input name="postpoint" value="<?php echo $mess['postpoint']; ?>"  style="width: 200px;" value="AAA"/>
                                </td>
                            </tr>
                            <tr>
                                <td style="background: #f5f5f5; width:30%;color: #337ab7; font-weight:600;">当前网点</td>
                                <td style="background: #fff">
                                    <input name="currentpoint" value="<?php echo $mess['currentpoint']; ?>"  style="width: 200px;" value="AAA"/>
                                </td>
                            </tr>
                            </div>
                            <!--快件为出仓时才可以显示下一站选择-->
                            <tr>
                                ...
                                <td style="background: #fff">
                                    <select name="nextpoint" id="nextpoint">
                                        <option value="0">-请选择下一站点-</option>
                                        <?php if(is_array($points) || $points instanceof \think\Collection || $points instanceof \think\Paginator): $i = 0; $__LIST__ = $points;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$point): $mod = ($i % 2 );++$i;if($mess['nextpoint'] == $point): ?>
                            ...
                            <tr>
                                ...
                                <td style="background: #fff">
                                    <select name="exstatus" id="exstatus">
                                        ...
                                        <?php else: ?>
                                        <option value="1" selected>已入仓</option>
                                        <?php endif; if($mess['status'] == '2'): ?>
                                        <option value="2" selected>已出仓</option>
                                        <?php else: ?>
                                        <option value="2" selected>已出仓</option>
                                        <?php endif; if($mess['status'] == '3'): ?>
                                        <option value="3" selected>派件中</option>
                                        <?php else: ?>
                                        <option value="3">派件中</option>
                                        <?php endif; if($mess['status'] == '4'): ?>
                            ...
                            <tr>
                                ...
                                <td style="background: #fff">
                                    <textarea name="description" value="<?php echo $mess['description']; ?>" rows="5" cols="50"></textarea>
                                </td>
                            </tr>
                            </tbody>
                        </table>
