<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"/opt/lampp/htdocs/tp5/public/../application/admin/view/express/ispro.html";i:1527862077;s:63:"/opt/lampp/htdocs/tp5/application/admin/view/public/header.html";i:1527872838;s:63:"/opt/lampp/htdocs/tp5/application/admin/view/public/bottom.html";i:1527862077;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <form style="float: right" role="form" method="post" action="<?php echo url('express/ispro'); ?>" name="indexexpress">
                        <?php if($word): ?>
                    ...
                    <div class="panel-heading">
                        <a href="index.html">快件列表</a> >> <a href="#">问题件</a>
                    </div>
                </a>
            </div>
            <!-- /.panel-heading -->
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="center">
                            ...
                            <button class="btn btn-success" onclick="javascript:showupdate('<?php echo $points; ?>','<?php echo $one['nextpoint']; ?>','<?php echo $one['number']; ?>')">更新</button>
...
<div class="modal fade" id="updateModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" method="post" action="<?php echo url('express/changestatus?type=2'); ?>" name="changeexpress">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <table width="100%" class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td style="background: #fff">
                                <input name="problem" type="radio" value="1" checked>是
                                <input name="problem" type="radio" style="margin-left: 20px;" value="0">否
                            </td>
                        </tr>
                        </tbody>
                    </table>
