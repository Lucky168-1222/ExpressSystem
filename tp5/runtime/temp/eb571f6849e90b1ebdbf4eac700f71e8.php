<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/opt/lampp/htdocs/tp5/public/../application/admin/view/index/news.html";i:1529123295;s:63:"/opt/lampp/htdocs/tp5/application/admin/view/public/header.html";i:1529123472;s:63:"/opt/lampp/htdocs/tp5/application/admin/view/public/bottom.html";i:1529051547;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div id="page-wrapper" style="padding-top: 40px;">
    <div class="row" style="border-bottom: 1px solid #eee;">
        ...
        <a href="/tp5/public/admin/index/news?type=1"><button>操作类</button></a>
        <a href="/tp5/public/admin/index/news?type=0"><button>阅读类</button></a>
        </div>
    </div>
    <ul class="dropdown-messages" style="list-style: none;width: 70%;margin:auto;">
        ...
        <li style="padding: 10px; border-bottom: 2px solid #CCCCCC;padding-bottom: 20px;">
            ...
            <div style="margin-top: 20px; text-align: right;">
                <?php if($one['is_action'] == 1): ?>
                <a href="/tp5/public/admin/index/deletenews?main1=<?php echo $one['main1']; ?>&time=<?php echo $one['time']; ?>"><button class="btn btn-danger" style="height: 30px;">删除</button></a>&nbsp;
                <button class="btn btn-toolbar" style="height: 30px;">同意</button>&nbsp;
                <button class="btn btn-toolbar" style="height: 30px;">驳回</button>
                <?php else: ?>
                <a href="/tp5/public/admin/index/deletenews?main1=<?php echo $one['main1']; ?>&time=<?php echo $one['time']; ?>"><button class="btn btn-danger" style="height: 30px;">删除</button></a>&nbsp;
        ...
        <li style="padding: 10px; border-bottom: 2px solid #CCCCCC;padding-bottom: 20px;">
            ...
            <div style="text-indent: 2em;margin-top: 8px;"><?php echo $one['action']; ?> => <?php echo $one['main2']; ?>
                <p style="float: right;"><a href="/tp5/public/admin/index/deletenews?main1=<?php echo $one['main1']; ?>&time=<?php echo $one['time']; ?>">删除</a></p>
                <p style="float: right;color: #CCCCCC;">已查看</p>
            </div>
            <?php else: ?>
            <div style="text-indent: 2em;margin-top: 8px;"><?php echo $one['action']; ?> => <?php echo $one['main2']; ?>
                <p style="float: right;"><a href="/tp5/public/admin/index/deletenews?main1=<?php echo $one['main1']; ?>&time=<?php echo $one['time']; ?>">删除</a></p>
